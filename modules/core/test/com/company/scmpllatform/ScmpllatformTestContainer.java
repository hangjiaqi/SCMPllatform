...
public class ScmpllatformTestContainer extends TestContainer {

    public ScmpllatformTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/scmpllatform/app.properties",
    ...
    public static class Common extends ScmpllatformTestContainer {

        public static final ScmpllatformTestContainer.Common INSTANCE = new ScmpllatformTestContainer.Common();
